...
const RecurringSummary = () => {
  ...
  const fetchTotalBudget = async () => {
    ...
    try {
      const response = await axios.get(`${API_URL}/departments/${currentUser.department_id}/dashboard/total-recurring-expense-count`);
  ...
  const fetchStatusCount = async (status) => {
    ...
    try {
      ...
      switch (status) {
        case 'Pending':
          endpoint = 'pending-recurring-expense-count';
          break;
        case 'Approved':
          endpoint = 'approved-recurring-expense-count';
          break;
        case 'Rejected':
          endpoint = 'rejected-recurring-expense-count';
          break;
        default:
